...
spark.sql("select * from PostesMeteo").show(5)
spark.sql("show databases").show()
spark.sql("use cours_spark")
spark.sql("show tabless").show()
spark.sql("DROP TABLE IF EXISTS cours_spark.postesmeteo")
postesMeteo.saveAsTable("postesmeteo")
spark.sql("show tabless").show()
spark.sql("select * from cours_spark.postesmeteo where ID < 8000 limit 5").show()
